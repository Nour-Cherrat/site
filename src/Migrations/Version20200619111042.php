 ...
 */
final class Version20200619111042 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE filiere ADD categorie INT NOT NULL, CHANGE nom_resp nom_resp VARCHAR(255) DEFAULT NULL, CHANGE email_resp email_resp VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE filiere DROP categorie, CHANGE nom_resp nom_resp VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE email_resp email_resp VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
