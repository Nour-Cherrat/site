 ...
 */
final class Version20200624103115 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce ADD date_debut DATE DEFAULT NULL, ADD date_fin DATE DEFAULT NULL, CHANGE filename filename VARCHAR(255) DEFAULT NULL, CHANGE pdfname pdfname VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE annonce DROP date_debut, DROP date_fin, CHANGE filename filename VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE pdfname pdfname VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
